...
void bothclientconcFirstChunk() {
   ...
   // get a list of all replica server addresses
    ...
    static std::string file_data[2] = {"client 1 file data update","client 2 fdu"};
    static int vals[2] = {1,2};
    threads.push_back(std::thread(execute,r1,r2,r3,file_data[0],vals[0]));
    threads.push_back(std::thread(execute,rc2_1,rc2_2,rc2_3,file_data[1],vals[1]));
